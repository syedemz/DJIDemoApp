package com.lordstarkandroid.fpvdemo;
/**
 * Created by lordstark on 15.02.17.
 */
...
import static dji.sdk.camera.DJICamera.*;
...
public class MainActivity extends AppCompatActivity implements TextureView.SurfaceTextureListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (camera != null) {
            ...
            camera.setDJICameraUpdatedSystemStateCallback(new CameraUpdatedSystemStateCallback() {
                @Override
